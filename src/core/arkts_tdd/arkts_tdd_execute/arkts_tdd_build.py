...
def run_test(options):
    ...
    for index, suite_file in enumerate(suite_file_list):
        ...
        if len(testsuite_summary) != 0:
            resultConstruction.testsuite_summary = testsuite_summary
            resultConstruction.start_time = start_time
            resultConstruction.end_time = end_time
            resultConstruction.suite_file_name = suite_name
            resultConstruction.node_construction(suite_result_file)
